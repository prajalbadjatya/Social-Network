...
//get api/profile/me
//to get my profile (current user)
//access private
// to get the profile of the user who is currently logged in
...
//Here we have to use both auth and validation middleware
router.post(
  "/",
  [
    auth,
  ...
  async(req, res) => {
    ...
    //First checking if there is a profile we wanna update it else we wanna create a new profile
    try{
 ...
 async(req,res)=> {
   ...
   //express-validator
     ...
     try {
       ...
       //unshift is like push but at the beginning of array
